...
function configureMcp(server, ResourceTemplate, z = zod_1.z) {
    try {
        ...
        server.tool('task-sample-generator', 'Generate diverse task samples based on tool descriptions and requirements', {
            ...
            complexity: z
                ...
                .optional()
                .default('all levels')
                .describe('Desired complexity level of generated tasks (default: all levels)'),
            num_samples: z
                .number()
                .min(1)
                .max(10)
            ...
            include_edge_cases: z
                ...
                .optional()
                .default(true)
                .describe('Whether to include edge cases in generated tasks (default: true)')
        }, async (args) => {
            console.log(`📤 [TOOL] task-sample-generator called with:`, JSON.stringify(args, null, 2));
            const prompt = [
            ...
            return {
                ...
                metadata: {
                    ...
                    include_edge_cases: args.include_edge_cases === undefined
                        ? true
                        : args.include_edge_cases
                }
            };
        });
        console.log('✅ [CONFIG] task-sample-generator tool registered successfully');
    }
    catch (error) {
